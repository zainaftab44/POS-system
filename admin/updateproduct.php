...
<td > <select  class="form-control" name="iname[]"> <option>a</option><option>b</option><option>c</option></select></td>
...
<input type="button" class="btn btn-success" id="save-product" value="Save Product">
        ...
        $(document).ready(function () {
            ...
            $("#add-more").click(function(e){
                ...
                next = next + 1;
                var newIn = '<tr id="'+next+'"><td><a href="#" class="btn btn-danger" >X</a></td><td> <select  class="form-control" name="iname[]"> <option>a</option><option>b</option><option>c</option></select></td><td> <input  class="form-control" type="number" placeholder="quantity" name="iqty[]"> </td></tr>';
                var newInput = $(newIn);
